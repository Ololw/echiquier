...
//Cree une case_t correspondant a la piece_t p et la couleur_t c
case_t case_t_de_pc(piece_t p, couleur_t c);

//Modifie la valeur de la case correspondant a la ligne i et la colonne j dans l'echiquier e pour lui donner la valeur ca
void set_case(echiquier_t* e, int i, int j, case_t ca);

//Cree un echiquier_t a sa valeur initiale (debut d'une partie)
echiquier_t init_echiquier();

//Renvoie la piece contenue dans la case ca
piece_t piece_t_de_case_t(case_t ca);

//Renvoie la couleur contenue dans la case ca
couleur_t couleur_t_de_case_t(case_t ca);

//Recupere la valeur de la case stockee dans l'echiquier, correspondant a la ligne i et la colonne j, et la stocke dans ca
